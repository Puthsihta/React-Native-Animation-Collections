...
const ROT_DEG = 360;
const SCALE = 1.3;
const TEXT = 'Moeurn Puthsitha Mobile Development Coding';
...
const brush = require('../assets/imgs/brush.png');

const AnimText: any = Animated.createAnimatedComponent(SvgText);
