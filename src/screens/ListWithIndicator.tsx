...
import {indiList} from 'assets/indiList';
...
const data = Object.keys(indiList).map(i => ({
  key: i,
  title: i,
  image: indiList[i as keyof typeof indiList],
  ref: React.createRef(),
}));
...
export default ListWithTabScreen;
