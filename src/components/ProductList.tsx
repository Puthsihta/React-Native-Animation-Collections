...
const ProductList = () => {
  const items: ListItem[] = [
    {
      name: 'Matt Black',
      image: require('../assets/imgs/black.png'),
    ...
    {
      name: 'White',
      image: require('../assets/imgs/skin.png'),
    ...
    {
      name: 'Blue',
      image: require('../assets/imgs/blue.png'),
  ...
  const onFlingLeft = (e: {nativeEvent: {state: number}}) => {
  ...
  const onFlingRight = (ev: {nativeEvent: {state: number}}) => {
